...
import { Settings, User as UserIcon, Mail, Calendar, Edit3, Save } from "lucide-react";

// Explicit types for user and article
type Article = {
  id: string;
  title: string;
  createdAt: Date;
...
export default async function DashboardSettingsPage() {
  ...
  // Calculate "Member Since" and "Days Active" safely
  const memberSince = user.createdAt ? user.createdAt.getFullYear() : "N/A";
